...
namespace XGameKit.Core
{
    ...
    public class XMessageManager : IXService
    {
        ...
        //父节点
        private XMessageManager _parent;
        //子节点
        private List<XMessageManager> _children = new List<XMessageManager>();
        ...
        public static void Append(XMessageManager parent, XMessageManager child)
        {
        ...
        public static void Remove(XMessageManager parent, XMessageManager child)
        {
            if (parent == null || child == null)
                return;
        ...
        protected void _SetParent(XMessageManager parent)
        {
            _parent = parent;
        }
        protected void _AddChild(XMessageManager child)
        {
            if (_children.Contains(child))
                return;
            _children.Add(child);
        }
        protected void _DelChild(XMessageManager child)
        {
            if (!_children.Contains(child))
                return;
